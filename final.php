    ...
    <div class="container current-page">
       <nav>
         <div class="nav-wrapper">
           <div class="col s12">
             <a href="index" class="breadcrumb">Начало</a>
             <a href="cart" class="breadcrumb">Количка</a>
             <a href="checkout" class="breadcrumb">Поръчай</a>
             <a href="final" class="breadcrumb">Благодарим ви!</a>
           </div>
         </div>
       </nav>
     </div>
...
<div class="container thanks">
  ...
  <div class="card center-align">
     ...
     <div class="card-content center-align">
       <h5>Благодарим ви за вашата покупка!</h5>
       <p>Ще Ви се обадим възможно най-скоро, за да потвърдим вашата покупката Dear : <h5 class="green-text"><?php echo"$firstname_sess". " " . "$lastname_sess";  ?></h5></p>
     </div>
   </div>

   <div class="center-align">
     <a href="details.php" class="button-rounded blue btn waves-effects waves-light">Детайли</a>
     <a href="index" class="button-rounded btn waves-effects waves-light">Начало</a>
   </div>
  </div>
  <div class="col s12 m3">
