<?php
 ...
 <div class="container print">
   <table>
      <thead>
        <tr>
            <th data-field="name">Продукт</th>
            <th data-field="category">Количество</th>
            <th data-field="price">Цена</th>
            <th data-field="quantity">Потребител</th>
    ...
    <div class="right-align">
      <p>Благодарим за вашето доверие © Fightball <?= date('Y'); ?></p>
    </div>

    <form method="post">
      <button type="submit" name="done" class="button-rounded waves-effect waves-light btn">Начало</button>
