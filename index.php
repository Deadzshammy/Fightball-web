      ...
      <div class="nav-wrapper">
        <form method="GET" action="search.php">
          ...
          <div class="center-align">
            <button type="submit" name="search" class="blue waves-light miaw waves-effect btn hide">Търси</button>
          </div>
        </form>
      </div>
    </nav>
    ...
    if ($resultfirst->num_rows > 0) {
      ...
      while($rowfirst = $resultfirst->fetch_assoc()) {
          ...
          <div class="container-fluid center-align categories">
            <a href="#category" class="button-rounded btn-large waves-effect waves-light">Категории</a>
              ...
              <div class="container-fluid about" id="about">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col s12 m6">
                      <h3 class="animated slideInUp wow">За нас</h3>
                      <div class="divider animated slideInUp wow"></div>
                      <p class="animated slideInUp wow">Коoрдинационен уред за тренировка - FIGHT BALL. Изработен от висококачествени материали за най - добра ефективност на тренировката. Подходящ за всякакъв вид боен спорт/бойно изкуство.Уредът е известен като разпускаща и забавна алтернатива на боя със сянка. Развива уменията за ловкост, рефлекс и бързина. Ако сте начинаещ и тепърва навлизате в спорта или тренирате от дълго време, за вас ще е добре да развиете качествата си чрез този уред. 
						Неограничена забава и удоволствие може да си доставите чрез FIGHT BALL, дори да не тренирате боен спорт. Децата или по – възрастните хора могат да си позволят една отпускаща напрежението, забавна играчка. Оползотворете свободния момент с FIGHT BALL.</p>
                      </div>
                    ...
                    <form class="col s12 animated slideInUp wow">
                      <div class="row">
                        <div class="input-field col s12 m6">
                          ...
                          <label for="icon_prefix">Вашето име</label>
                        </div>
                        <div class="input-field col s12 m6">
                          <i class="material-icons prefix">email</i>
                          <input id="email" type="email" class="validate">
                          <label for="email" data-error="wrong" data-success="right">Имейл</label>
                        </div>
                        ...
                        <div class="input-field col s12 ">
                          ...
                          <label for="icon_prefix2">Информация</label>
                        </div>

                        <div class="center-align">
                          <button type="submit" name="contact" class="button-rounded btn-large waves-effect waves-light">Изпрати</button>
                        </div>
                      </div>
                    </form>
                  </div>
