...
<li><a class="blue-text" href="editprofile">Редактиране на профила</a></li>
<li><a class="blue-text" href="includes/logout">Изход</a></li>
</ul>
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul class="left hide-on-med-and-down">
     ...
     <li><a href="index" class="dark-text">Fightball</a></li>
   ...
   <ul  class="right hide-on-med-and-down">
       <li><a href="index" class="dark-text">Начало</a></li>
