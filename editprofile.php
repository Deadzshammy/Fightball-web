   ...
   <div class="container current-page">
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            <a href="index" class="breadcrumb">Fightball</a>
            <a href="editprofile" class="breadcrumb">Редактирайте профила си</a>
          </div>
        </div>
      </nav>
    </div>
       ...
       <div class="input-field col s12 meh">
         ...
         <label for="icon_prefix">Потвърдете новата парола</label>
           ...
           <div class="center-align">
               <button type="submit" id="confirmed" name="update" class="btn meh button-rounded waves-effect waves-light ">Изпрати</button>
           </div>
